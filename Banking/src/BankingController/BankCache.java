...
import BankingModel.AccountDet;
import BankingModel.CustomerDet;
import BankingModel.LoanPojo;
import BankingModel.TransactionPojo;
...
public class BankCache {
	...
	Map<Integer,AccountDet>  adminMap=new HashMap<>();
	Map<Integer,ArrayList<Integer>> listMap=new HashMap<>();
	static Map<Integer,ArrayList<TransactionPojo>>  trans=new HashMap<>();
	...
	public int accId1=1;
	private String pass="name@12345";
	...
	public BankCache()
	{
		...
		account.setRoleID(accId1);
		account.setPassword(pass);
		accountMap.put(getCustomerId(), account);
	}
	public void emptyCheck(String value) throws Exception
	{
	...
	public String  loginMethod(int userId,String pass) throws Exception,AccountException
	{
		emptyCheck(pass);
	...
	public int  userCredentials(int userId,String password) throws Exception,AccountException
	{
		emptyCheck(password);
		CustomerDet custom=customMap.get(userId);
		AccountDet admin=new AccountDet();
		if(userId == admin.getRoleID() && password.equals(admin.getPassword()))
		{
			return 1;
		}
	...
	public void amountDeposit(int accountId,double bal,int customerId) throws Exception
	{
		...
		ArrayList<TransactionPojo> list=new ArrayList<>();
	...
	public void withdrawlAmount(int accountId,double bal,int customerId) throws Exception
	{
		...
		LocalTime myObj1 = LocalTime.now();
		TransactionPojo hist=new TransactionPojo();
		ArrayList<TransactionPojo> listtype=trans.get(customerId);
		
		if(listtype == null)
		{
			listtype=new ArrayList<TransactionPojo>();
	...
	public double balanceEnquiry(int accountId) throws Exception
	{
		if(accountMap == null)
		{
			System.out.println("the account Map is empty");
	...
	public void customerAccountDetails(int cusId) throws Exception
	{
		if(listMap== null)
		{
			System.out.println("the account Map is empty");
	...
	public double allAccountsBalance(int cusId) throws Exception
	{
		if(accountMap== null)
		{
			System.out.println("the account Map is empty");
	...
	public int openAccountInBank(CustomerDet customDet,AccountDet accountDet)  throws Exception
	{
	...
	public   ArrayList<TransactionPojo>  getTransactionDetails(int customerId) throws Exception
	{
		if(trans ==null)	
		{
	...
	public LoanPojo loanAppliedstatus(int accountId) throws Exception
	{
	...
	public Map<Integer,ArrayList<TransactionPojo>> adminTransactionHistory() throws Exception
	{
		if(trans == null)
		{
